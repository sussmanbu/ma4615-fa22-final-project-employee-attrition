...
global_temp <- read_csv(here::here("dataset", "annual temperature.txt"))

## CLEAN the data
global_temp_clean <- global_temp

write_csv(global_temp_clean, file = here::here("dataset", "annual temperature.txt"))

save(global_temp_clean, file = here::here("dataset/annual temperature.RData"))
```
