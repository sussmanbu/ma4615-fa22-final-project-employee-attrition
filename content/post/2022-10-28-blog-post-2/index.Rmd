...
global_temp <- read.csv(here::here("dataset", "annual_temperature.txt"))


## CLEAN the data
global_temp_clean <- global_temp

write.csv(global_temp_clean, file = here::here("dataset", "annual_temperature.txt"))

save(global_temp_clean, file = here::here("dataset/annual_temperature.RData"))
```
