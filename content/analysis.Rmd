...
p2 = World_data %>% ggplot(aes(as.numeric(Year),forest_area)) + geom_line() +
...
mlr1 = lm(temperature ~ World_data$population + World_data$forest_area +Gas + Oil + Coal + CO2emission)
summary(mlr1)
